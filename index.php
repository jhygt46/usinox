                                ...
                                <div class="lista_productos clearfix">
                                    ...
                                    <div class="producto">
                                        <div class="pro">
                                            <div class="c_pro">
                                                <div class="c_pfoto">
                                                    <a href="<?php echo $inicio['childs_cat'][$i]['urls']; ?>"><img src="https://www.usinox.cl/foto.php?archivo=http://35.202.149.15/uploads/images/<?php echo $foto; ?>&ancho=218&alto=180" alt="" /></a>
                                                </div>
